...
import com.wuye.manage.wuye.unit.entity.UnitManagerVo;
...
public interface UnitMapper extends BaseMapper<Unit> {
    ...
    @Select("select a.*, b.manager_name from unit left join community_manager b on a.cmid = b. cmid")
    public IPage<UnitManagerVo> selectPageWithManager(Page<UnitManagerVo> page, @Param(Constants.WRAPPER) Wrapper wrapper, @Param("cid") Integer cid);
}
